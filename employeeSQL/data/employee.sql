...
ALTER TABLE Employee ALTER COLUMN hire_date TYPE Date USING to_date(hire_date, 'MM/DD/YYYY');
ALTER TABLE Employee ALTER COLUMN birth_date TYPE Date USING to_date(birth_date, 'MM/DD/YYYY');
